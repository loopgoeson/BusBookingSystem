...
class bus_booking:
    ...
    def journey_detail_page(self):
        ...
        def show_bus():
            ...
            jd_test=journey_date.get()
            jd_ls=jd_test.split("/")
            jd="20"+jd_ls[2]+"-"+jd_ls[1]+"-"+jd_ls[0]
            print(jd)
        ...
        journey_date= DateEntry(root, width=12, background='darkblue',foreground='white', borderwidth=2, year=2023)
        journey_date.grid(row=4,column=8)
